...
public class Vigenere_AutoKey {
    ...
    public static void main(String[] args) {
            ...
            va.setKhoa("YOUREON");
            va.setBanRo("MONEYMAKESTHE");
            System.out.println("Ban ma MaCoDien.Vigenere_AutoKey : " + va.maHoa());
            System.out.println("Ban ro MaCoDien.Vigenere_AutoKey : " + va.giaiMa());
    }
}
