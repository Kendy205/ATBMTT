...
public class Vigenere_LapKhoa {
    ...
    public static void main(String[] args) {
            ...
            Vigenere_LapKhoa v = new Vigenere_LapKhoa();
            v.setKhoa("YOUREON");
            v.setBanRo("MONEYMAKESTHE");
            System.out.println("Ban ma MaCoDien.Vigenere_LapKhoa : " + v.maHoa());
            System.out.println("Ban ro MaCoDien.Vigenere_LapKhoa : " + v.giaiMa());
    }
}
